...
var DayColumn = function (_a) {
    ...
    return (jsxs("div", __assign({ className: classNames.day + " " + day, style: style }, { children: [jsx("div", __assign({ className: classNames.day_title, style: { height: "85px" } }, { children: getDayLabel(day) }), void 0), jsx(EventsList, { onEventClick: onEventClick, events: events, day: day, hoursInterval: hoursInterval, rowHeight: rowHeight, renderEvent: renderEvent }, void 0), jsx("div", { onMouseDown: handler, onTouchStart: handler, className: classNames.resize_handler }, void 0)] }), void 0));
};

var DEFAULT_HOURS_INTERVAL = { from: 7, to: 24 };

var TimeTableJSX = function (_a) {
    var events = _a.events, onEventClick = _a.onEventClick, _b = _a.hoursInterval, hoursInterval = _b === void 0 ? DEFAULT_HOURS_INTERVAL : _b, _c = _a.timeLabel, timeLabel = _c === void 0 ? "Time" : _c, _d = _a.getDayLabel, getDayLabel = _d === void 0 ? getDefaultDayLabel : _d, _e = _a.renderEvent, renderEvent = _e === void 0 ? function (event) { return (jsxs(Fragment, { children: [jsx("span", __assign({ className: classNames.event_info }, { children: event.name }), void 0), differenceInMinutes(event.endTime, event.startTime) > 30 ? (jsx("span", __assign({ className: classNames.event_info }, { children: event.vehicle }), void 0)) : (""), differenceInMinutes(event.endTime, event.startTime) > 20 ? (jsx("span", __assign({ className: classNames.event_info }, { children: event.city }), void 0)) : (""), jsxs("span", __assign({ className: classNames.event_info }, { children: [format(event.startTime, "hh:mm"), " - ", format(event.endTime, "hh:mm")] }), void 0)] }, void 0)); } : _e;
