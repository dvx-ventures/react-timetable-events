...
var EventsList = function (_a) {
    ...
    var intersectingEvents = React__default.useMemo(function () {
        return getOverlaps(sortEvents(events[day]));
    }, [day]);
    return (jsx(Fragment, { children: intersectingEvents.flatMap(function (_events) {
...
var DayColumn = function (_a) {
    ...
    return (jsxs("div", __assign({ className: "" + classNames.day, style: style }, { children: [jsx("div", __assign({ className: classNames.day_title + "  " + (disabled ? classNames.day_title__disalbed : ""), style: { width: size } }, { children: getDayLabel(day) }), void 0), showCurrentTime && (jsx(CurrentTime, { hoursInterval: hoursInterval, rowHeight: rowHeight }, void 0)), jsx(EventsList, { onEventClick: onEventClick, events: events, day: day, hoursInterval: hoursInterval, rowHeight: rowHeight, renderEvent: renderEvent }, void 0), jsx("div", { onMouseDown: handler, onTouchStart: handler, className: classNames.resize_handler }, void 0)] }), void 0));
};
...
var CurrentTime = function (_a) {
    var hoursInterval = _a.hoursInterval, rowHeight = _a.rowHeight;
    var _b = React__default.useState(), topPosition = _b[0], setTopPosition = _b[1];
    React__default.useEffect(function () {
