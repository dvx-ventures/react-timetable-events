...
var DayColumn = function (_a) {
    ...
    return (jsxs("div", __assign({ className: classNames.day + " " + day, style: style }, { children: [jsx("div", __assign({ className: classNames.day_title, style: { width: size } }, { children: getDayLabel(day) }), void 0), showCurrentTime && (jsx(CurrentTime, { hoursInterval: hoursInterval, rowHeight: rowHeight }, void 0)), jsx(EventsList, { onEventClick: onEventClick, events: events, day: day, hoursInterval: hoursInterval, rowHeight: rowHeight, renderEvent: renderEvent }, void 0), jsx("div", { onMouseDown: handler, onTouchStart: handler, className: classNames.resize_handler }, void 0)] }), void 0));
};
