...
var EventPreviewJSX = function (_a) {
    ...
    return (createElement("div", __assign({}, defaultAttributes, { style: __assign(__assign({}, defaultAttributes.style), { background: event.type === "COMPLETE" ? "#66B266" : event.type === "CANCELLED" ? "#FF0000" : 'GOLD' }), title: event.name, key: event.id }),
        jsxs(Fragment, { children: [jsx("span", __assign({ className: classNames.event_info }, { children: event.name }), void 0), jsx("span", __assign({ className: classNames.event_info }, { children: event.vehicle }), void 0), jsx("span", __assign({ className: classNames.event_info }, { children: event.city }), void 0), jsxs("span", __assign({ className: classNames.event_info }, { children: [format(event.startTime, "hh:mm"), " - ", format(event.endTime, "hh:mm")] }), void 0)] }, void 0)));
};
