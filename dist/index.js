...
var EventsList = function (_a) {
    ...
    return (jsxRuntime.jsx(jsxRuntime.Fragment, { children: isUnassigned(day)
            ? intersectingEvents.flatMap(function (_events) {
                return _events.map(function (event, i) { return (jsxRuntime.jsx(EventsListItem, __assign({ event: event, events: _events, index: i }, props), day + "-" + i + "-" + event.name)); });
            })
            : events[day].map(function (event, i) { return (React.createElement(EventsListItem, __assign({ event: event, events: events[day], index: i }, props, { key: day + "-" + i + "-" + event.name }))); }) }, void 0));
};
...
var DayColumn = function (_a) {
    ...
    return (jsxRuntime.jsxs("div", __assign({ className: classNames.day + " " + day, style: style }, { children: [jsxRuntime.jsx("div", __assign({ className: classNames.day_title, style: { height: "57px" } }, { children: getDayLabel(day) }), void 0), jsxRuntime.jsx(EventsList, { onEventClick: onEventClick, events: events, day: day, hoursInterval: hoursInterval, rowHeight: rowHeight }, void 0), jsxRuntime.jsx("div", { onMouseDown: handler, onTouchStart: handler, className: classNames.resize_handler }, void 0)] }), void 0));
};
