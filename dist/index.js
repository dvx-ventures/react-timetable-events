...
var DayColumn = function (_a) {
    ...
    return (jsxRuntime.jsxs("div", __assign({ className: "".concat(classNames.day, " ").concat(day), style: style }, { children: [jsxRuntime.jsx("div", __assign({ className: classNames.day_title, style: { height: "85px" } }, { children: getDayLabel(day) }), void 0), jsxRuntime.jsx(EventsList, { onEventClick: onEventClick, events: events, day: day, hoursInterval: hoursInterval, rowHeight: rowHeight, renderEvent: renderEvent }, void 0), jsxRuntime.jsx("div", { onMouseDown: handler, onTouchStart: handler, className: classNames.resize_handler }, void 0)] }), void 0));
};
...
var TimeTableJSX = function (_a) {
    ...
    return (jsxRuntime.jsxs("div", __assign({ style: { position: "relative" } }, { children: [showCurrentTime && (jsxRuntime.jsx(CurrentTime, { hoursInterval: hoursInterval, rowHeight: rowHeight }, void 0)), jsxRuntime.jsxs("div", __assign({ className: classNames.time_table_wrapper }, { children: [jsxRuntime.jsxs("div", __assign({ className: classNames.time }, { children: [jsxRuntime.jsx("div", __assign({ className: classNames.time_label, style: { height: "85px" } }, { children: timeLabel }), void 0), range$1(hoursInterval.from, hoursInterval.to).map(function (hour) { return (jsxRuntime.jsx(Hour, { hour: hour, style: { height: "".concat(rowHeight, "%") } }, "".concat(hour, "-").concat(nanoid()))); })] }), void 0), Object.keys(events).map(function (day, index) { return (jsxRuntime.jsx(DayColumn, { onEventClick: onEventClick, events: events, day: day, index: index, rowHeight: rowHeight, getDayLabel: getDayLabel, hoursInterval: hoursInterval, renderEvent: renderEvent, width: dayColumnSizes ? dayColumnSizes[day] : undefined, onSizeChanged: onDayComunSizeChanged }, day + nanoid())); })] }), void 0)] }), void 0));
};
