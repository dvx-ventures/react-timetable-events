...
var getEventPositionStyles = function (_a) {
    ...
    return {
        ...
        marginTop: ((minutesFromStartOfDay * rowHeight) / 60 / 100) * 1500 + 85 + "px",
    };
};
var getCurrentTimePosition = function (_a) {
    var hoursInterval = _a.hoursInterval, rowHeight = _a.rowHeight;
    var currentDate = new Date();
    if (currentDate.getHours() > hoursInterval.to + 1 ||
...
var EventsList = function (_a) {
    ...
    return (jsxRuntime.jsx(jsxRuntime.Fragment, { children: intersectingEvents.flatMap(function (_events) {
            return _events.map(function (event, i) { return (jsxRuntime.jsx(EventsListItem, __assign({ event: event, events: _events, index: i }, props), event.id + nanoid())); });
        }) }, void 0));
};
...
function useResizable(option) {
    ...
    var handleStartMove = React__namespace.useCallback(function (event) {
        actions.start({
...
var DayColumn = function (_a) {
    var events = _a.events, day = _a.day, rowHeight = _a.rowHeight, getDayLabel = _a.getDayLabel, hoursInterval = _a.hoursInterval, onEventClick = _a.onEventClick, renderEvent = _a.renderEvent, width = _a.width, onSizeChanged = _a.onSizeChanged, showCurrentTime = _a.showCurrentTime, disabled = _a.disabled;
    var _b = useResizable({
        minSize: 100,
        maxSize: 12000,
        size: width ? width : day === "UNASSIGNED" ? 300 : 200,
        direction: "right",
    }), isMove = _b.isMove, size = _b.size, handler = _b.handler;
    React__default['default'].useEffect(function () {
        if (isMove === false && onSizeChanged)
    ...
    return (jsxRuntime.jsxs("div", __assign({ className: "" + classNames.day, style: style }, { children: [jsxRuntime.jsx("div", __assign({ className: classNames.day_title + "  " + (disabled ? classNames.day_title__disalbed : ""), style: { width: size } }, { children: getDayLabel(day) }), void 0), showCurrentTime && (jsxRuntime.jsx(CurrentTime, { hoursInterval: hoursInterval, rowHeight: rowHeight }, void 0)), jsxRuntime.jsx(EventsList, { onEventClick: onEventClick, events: events, day: day, hoursInterval: hoursInterval, rowHeight: rowHeight, renderEvent: renderEvent }, void 0), jsxRuntime.jsx("div", { onMouseDown: handler, onTouchStart: handler, className: classNames.resize_handler }, void 0)] }), void 0));
};

var DefaultEventLayout = function (event) { return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx("span", __assign({ className: classNames.event_info }, { children: event.name }), void 0), differenceInMinutes(event.endTime, event.startTime) > 30 ? (jsxRuntime.jsx("span", __assign({ className: classNames.event_info }, { children: event.vehicle }), void 0)) : (""), differenceInMinutes(event.endTime, event.startTime) > 20 ? (jsxRuntime.jsx("span", __assign({ className: classNames.event_info }, { children: event.city }), void 0)) : (""), jsxRuntime.jsxs("span", __assign({ className: classNames.event_info }, { children: [format(event.startTime, "hh:mm"), " - ", format(event.endTime, "hh:mm")] }), void 0)] }, void 0)); };

var CurrentTime = function (_a) {
    var hoursInterval = _a.hoursInterval, rowHeight = _a.rowHeight;
    var _b = React__default['default'].useState(), topPosition = _b[0], setTopPosition = _b[1];
    React__default['default'].useEffect(function () {
        setTopPosition(getCurrentTimePosition({ hoursInterval: hoursInterval, rowHeight: rowHeight }));
        var interval = setInterval(function () {
            setTopPosition(getCurrentTimePosition({ hoursInterval: hoursInterval, rowHeight: rowHeight }));
        }, 10 * 1000);
        return function () { return clearInterval(interval); };
    }, [hoursInterval, rowHeight]);
    return topPosition !== undefined ? (jsxRuntime.jsx("div", { className: classNames.time_current, style: { top: topPosition + "px" } }, void 0)) : null;
};

var DEFAULT_HOURS_INTERVAL = { from: 7, to: 24 };

var TimeTableJSX = function (_a) {
    var events = _a.events, onEventClick = _a.onEventClick, _b = _a.hoursInterval, hoursInterval = _b === void 0 ? DEFAULT_HOURS_INTERVAL : _b, _c = _a.timeLabel, timeLabel = _c === void 0 ? "Time" : _c, _d = _a.getDayLabel, getDayLabel = _d === void 0 ? getDefaultDayLabel : _d, _e = _a.renderEvent, renderEvent = _e === void 0 ? DefaultEventLayout : _e, dayColumnSizes = _a.dayColumnSizes, dayColumnsDisabled = _a.dayColumnsDisabled, onDayComunSizeChanged = _a.onDayComunSizeChanged, showCurrentTime = _a.showCurrentTime;
    var _f = React__namespace.useState(0), rowHeight = _f[0], setRowHeight = _f[1];
    React__namespace.useEffect(function () {
        setRowHeight(getRowHeight(hoursInterval.from, hoursInterval.to));
    }, [hoursInterval]);
    return (jsxRuntime.jsx(jsxRuntime.Fragment, { children: jsxRuntime.jsxs("div", __assign({ className: classNames.time_table_wrapper }, { children: [jsxRuntime.jsxs("div", __assign({ className: classNames.time }, { children: [jsxRuntime.jsx("div", __assign({ className: classNames.time_label }, { children: timeLabel }), void 0), range(hoursInterval.from, hoursInterval.to).map(function (hour, index) { return (jsxRuntime.jsx(Hour, { hour: hour, style: {
                                height: rowHeight + "%",
                                marginTop: index === 0 ? "85px" : 0,
                            } }, hour + "-" + nanoid())); })] }), void 0), Object.keys(events).map(function (day, index) { return (jsxRuntime.jsx(DayColumn, { onEventClick: onEventClick, events: events, day: day, index: index, rowHeight: rowHeight, getDayLabel: getDayLabel, hoursInterval: hoursInterval, renderEvent: renderEvent, width: dayColumnSizes ? dayColumnSizes[day] : undefined, onSizeChanged: onDayComunSizeChanged, showCurrentTime: showCurrentTime, disabled: dayColumnsDisabled ? dayColumnsDisabled[day] : false }, day + nanoid())); })] }), void 0) }, void 0));
};
