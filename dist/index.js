...
var DayColumn = function (_a) {
    var events = _a.events, day = _a.day, rowHeight = _a.rowHeight, getDayLabel = _a.getDayLabel, hoursInterval = _a.hoursInterval, onEventClick = _a.onEventClick, renderEvent = _a.renderEvent;
    var _b = useResizable({
        minSize: 100,
        maxSize: 12000,
    ...
    return (jsxRuntime.jsxs("div", __assign({ className: classNames.day + " " + day, style: style }, { children: [jsxRuntime.jsx("div", __assign({ className: classNames.day_title, style: { height: "85px" } }, { children: getDayLabel(day) }), void 0), jsxRuntime.jsx(EventsList, { onEventClick: onEventClick, events: events, day: day, hoursInterval: hoursInterval, rowHeight: rowHeight, renderEvent: renderEvent }, void 0), jsxRuntime.jsx("div", { onMouseDown: handler, onTouchStart: handler, className: classNames.resize_handler }, void 0)] }), void 0));
};
...
var TimeTableJSX = function (_a) {
    var events = _a.events, onEventClick = _a.onEventClick, _b = _a.hoursInterval, hoursInterval = _b === void 0 ? DEFAULT_HOURS_INTERVAL : _b, _c = _a.timeLabel, timeLabel = _c === void 0 ? "Time" : _c, _d = _a.getDayLabel, getDayLabel = _d === void 0 ? getDefaultDayLabel : _d, _e = _a.renderEvent, renderEvent = _e === void 0 ? DefaultEventLayout : _e;
