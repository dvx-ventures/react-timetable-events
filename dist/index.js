...
var DayColumn = function (_a) {
    ...
    return (jsxRuntime.jsxs("div", __assign({ className: classNames.day + " " + day, style: style }, { children: [jsxRuntime.jsx("div", __assign({ className: classNames.day_title, style: { width: size } }, { children: getDayLabel(day) }), void 0), showCurrentTime && (jsxRuntime.jsx(CurrentTime, { hoursInterval: hoursInterval, rowHeight: rowHeight }, void 0)), jsxRuntime.jsx(EventsList, { onEventClick: onEventClick, events: events, day: day, hoursInterval: hoursInterval, rowHeight: rowHeight, renderEvent: renderEvent }, void 0), jsxRuntime.jsx("div", { onMouseDown: handler, onTouchStart: handler, className: classNames.resize_handler }, void 0)] }), void 0));
};
